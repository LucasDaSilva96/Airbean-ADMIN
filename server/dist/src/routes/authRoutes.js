...
import { signUp_post, login_post, logout_get, updateUser_patch, } from '../controllers/authController.js';
...
// PATCH - Protect
authRouter.patch('/updateUser', protect, upload.single('image'), updateUser_patch);
